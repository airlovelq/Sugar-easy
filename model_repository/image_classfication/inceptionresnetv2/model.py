...
class InceptionResNetV2(object):
    ...
    def __init__(self, **knobs):
        ...
        self._model = None
        self._image_size = knobs.get('image_size', 75) if knobs.get('image_size', 75) >= 200 else 200
    ...
    def _build_classifier(self, l_rate):
        model = tf.keras.applications.InceptionResNetV2(input_shape=(self._image_size, self._image_size, 3),weights=None,classes=self._num_classes,include_top=True)
        adam = Adam(lr=l_rate,
                    beta_1=0.9,
                    beta_2=0.999,
                    epsilon=None,
