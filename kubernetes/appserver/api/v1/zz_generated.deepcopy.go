...
func (in *AppServerSpec) DeepCopyInto(out *AppServerSpec) {
	*out = *in
	...
	if in.ReplicasMax != nil {
		in, out := &in.ReplicasMax, &out.ReplicasMax
		*out = new(int32)
		**out = **in
	}
	in.ModelVolume.DeepCopyInto(&out.ModelVolume)
	in.ModelParamVolume.DeepCopyInto(&out.ModelParamVolume)
